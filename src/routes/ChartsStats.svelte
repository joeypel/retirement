...
<section class="mb-32 text-gray-800 text-center">
	<div class="grid md:grid-cols-3 lg:grid-cols-3 gap-x-6 lg:gap-x-0 items-center">
		<div class="mb-12 lg:mb-0 relative">
			...
			<h6 class="font-medium text-gray-500">Total Saved</h6>
			<p class="font-medium text-sm text-gray-500">Over {chartData[1].length - 1} years</p>
		...
		<div class="mb-12 lg:mb-0 relative">
			...
			<h5 class="text-lg font-medium text-blue-600 font-bold mb-4">
				{`$${Number(totalContributed).toLocaleString()}`}
			</h5>
		...
		<!-- <div class="relative">
			...
			<h6 class="font-medium text-gray-500 mb-0">{`$${totalSaved}`}</h6>
		</div> -->
	</div>
</section>
<!-- Section: Design Block -->
